...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        dischargeExportButton.Text =
            "▶ ВЫГРУЗИТЬ РАЗРЯЖЕНИЕ — 4 ЭКРАНА";

        dischargeExportButton.Dock =
            DockStyle.Fill;

        dischargeExportButton.Height =
            52;

        dischargeExportButton.Font =
            new Font(
                "Segoe UI",
                11,
                FontStyle.Bold);

        dischargeExportButton.Click +=
            async (_, _) =>
            {
        ...
        dischargeSetupButton.Text =
            "⚙ Разряжение";

        dischargeSetupButton.Dock =
            DockStyle.Fill;

        dischargeSetupButton.Margin =
            new Padding(3);

        dischargeSetupButton.Click +=
            (_, _) =>
            {
                StartDischargeSetup();
            };
        ...
        Log(
            "Доступна отдельная выгрузка отчёта по разряжению.");
