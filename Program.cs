...
Log(
    "Английская раскладка включена.");

// -------------------------------------------------
// ПОВТОРНО АКТИВИРУЕМ ПОЛЕ ИМЕНИ
// -------------------------------------------------
...
// Ставим курсор строго в конец имени.
SendKeys.SendWait(
    "{END}");
...
Log(
    "Поле имени повторно активировано.");

// -------------------------------------------------
// ВВОД АНГЛИЙСКОЙ ЧАСТИ
// -------------------------------------------------
...
Log(
    "Русская раскладка восстановлена.");
            // -------------------------------------------------
            // EN -> RU
            // -------------------------------------------------
